...
public class UAS {
    public static void main(String[] args) {
        ...
        int[] noTes = {2001, 4002, 2005, 2007};
        String[] namaPeserta = {"BASKARA", "AMBA", "AGUS", "HILMI"};
        char[][] jawabanPeserta = {
            {'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A'},
            {'B', 'A', 'A', 'A', 'A', 'A', 'A', 'D'},
            {'A', 'B', 'A', 'A', 'C', 'A', 'A', 'A'},
        ...
        Jawaban(noTes, namaPeserta, jawabanPeserta);
        KunciJawaban(kunciJawaban);
        HasilUjian(noTes, namaPeserta, jumlahBenar, nilai);
    }
    public static void Jawaban(int[] noTes, String[] namaPeserta, char[][] jawabanPeserta) {
    ...
    public static void HasilUjian(int[] noTes, String[] namaPeserta, int[] jumlahBenar, double[] nilai) {
        System.out.println("\nNilai Peserta Ujian");
